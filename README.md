# @hishprorg/natus-ullam

[![npm version](https://badge.fury.io/js/@hishprorg/natus-ullam.svg)](https://badge.fury.io/js/@hishprorg/natus-ullam)
[![downloads count](https://img.shields.io/npm/dt/@hishprorg/natus-ullam.svg)](https://www.npmjs.com/package/@hishprorg/natus-ullam)
[![github-ci](https://github.com/hishprorg/natus-ullam/actions/workflows/testing.yml/badge.svg)](https://github.com/hishprorg/natus-ullam/actions/workflows/testing.yml)
...
Next, install `@hishprorg/natus-ullam`:

```bash
npm install -D @hishprorg/natus-ullam
```
